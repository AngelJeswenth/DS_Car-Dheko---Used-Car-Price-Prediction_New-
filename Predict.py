...
def app():
    ...
    @st.cache_data
    def load_data():
        df = pd.read_csv("C:/Users/HP/OneDrive/Desktop/Car_dehko/Cleaned_Car_Dheko.csv")
        df1 = pd.read_csv("C:/Users/HP/OneDrive/Desktop/Car_dehko/Preprocessed_Car_Dheko.csv")
        return df, df1
   ...
   # def load_model():
    ...
    @st.cache_resource
    def load_model():
     Model_path = "C:/Users/HP/OneDrive/Desktop/Car_dehko/GradientBoost_model.pkl"
